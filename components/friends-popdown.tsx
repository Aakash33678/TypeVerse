...
export function FriendsPopdown({ socket, isConnected }: FriendsPopdownProps) {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        align="end"
        className={`${isExpandedFriendsView ? "w-190" : "w-90"} p-3`}
      >
        ...
        {activeTab === "friends" && (
          activeChatFriend ? (
            <div className="grid min-h-105 gap-3 md:grid-cols-[260px_minmax(0,1fr)]">
              ...
              <div className="flex h-full min-h-90 flex-col rounded-md border border-border">
            ...
            <div className="rounded-md border border-border">
              <div className="max-h-35 space-y-1 overflow-y-auto p-2">
                {loadingFriends ? (
                  <div className="flex justify-center py-6">
                    <Loader2 className="animate-spin text-muted-foreground" size={18} />
                  </div>
